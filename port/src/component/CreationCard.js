...
import ecommerce from '../utils/ecommerce.jpg'
    ...
    <div className="creation__card">
      <Card className={classes.root}>
        ...
        <div className="description description__blur">
          <h1>Courshop</h1>
          <h2>Sell and buy your favorite product for your life!</h2>
          <p>
            An simplest e-commerce app that you can sell and buy any products
          </p>
        </div>
        <div className="creation__IconButton">
          <IconButton
            className={classes.button}
            href="http://group-ten-frontend.s3-website.us-east-2.amazonaws.com/"
          >
            <LaunchRoundedIcon className={classes.icon} />
          </IconButton>
          <IconButton
            className={classes.button}
            href="https://github.com/abdurrahmanmohammad/CourshopFrontendSpringBoot"
          >
